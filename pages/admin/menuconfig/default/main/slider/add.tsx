...
const SliderAddPage = ({permissions={}}: any) => {
    ...
    return (
        <Layout perms={permissions}>
            ...
            <form onSubmit={handleSubmit(handleSendData)} style={{textAlign: "center"}}>
                <div>
                    <img
                ...
                >
                    ...
                    sx={{
                        ...
                        fontSize: "12px",
                        padding: "0 5px",
                        color: loading ? "rgba(255, 255, 255, 0.25)" : (errors.desc ? "red" : "#cfd8dc"),
                ...
                <CButton disabled={loading} LinkComponent={Link} href="/admin/menuconfig/default/main#slider">Wróć</CButton>
